...
machine; if you want to use another system for compiling, check
...
* During the next step to ':ref:`disable any kernel superfluous apparently
...
* Continue the guide, but ignore the instructions outlining how to compile,
  ...
  last line shown; for a x86 kernel with the kernelrelease identifier
  '6.0.0-rc1-local-g928a87efa423' this usually will be stored as
